  ...
  return (
    <div className="bg-gray-800 border border-gray-700 rounded-xl p-4">
      <div className="flex items-center justify-between mb-3">
        <span className="text-gray-400 text-xs font-medium">Campo {index + 1}</span>
      ...
      <div className="mb-3">
        <label className="block text-xs text-gray-500 mb-1">Pregunta / Etiqueta</label>
        <input
          type="text"
          value={field.label}
          onChange={e => onChange({ ...field, label: e.target.value })}
          placeholder="Ej: ¿Cuál es el nombre de tu negocio?"
